...
conda相关的内容请参考[[miniconda]]

## Cuda

conda也可以直接安装cuda, 但是这种方式的cuda是未编译的, 在[[module#pip|pip]]下载一些库会出现严重问题(说你呢, [PyTorch3d](https://github.com/facebookresearch/pytorch3d), 但是可以通过这个解决: [third-party](https://github.com/facebookresearch/pytorch3d/discussions/1752))

下载: 
```shell
conda install nvidia/label/cuda-<major>.<median>.<minor>::cuda
```

`<major>.<median>.<minor>`指的是CUDA的版本, 如`11.8.0`, `12.4.1`等等
