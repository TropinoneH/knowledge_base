...
<img src="./assets/Snipaste_2023-04-24_10-36-07.png" style="zoom:33%;" />
...
<div style="display: flex">
    <img src="./assets/Snipaste_2023-04-24_10-46-24.png" style="zoom:38%;" />
    <img src="./assets/Snipaste_2023-04-24_10-46-35.png" style="zoom:38%;" />
    <img src="./assets/Snipaste_2023-04-24_10-46-55.png" style="zoom:38%;" />
</div>

<div style="display: flex">
    <img src="./assets/Snipaste_2023-04-24_10-48-52.png" style="zoom:38%;" />
    <img src="./assets/Snipaste_2023-04-24_10-49-04.png" style="zoom:38%;" />
    <img src="./assets/Snipaste_2023-04-24_10-49-12.png" style="zoom:38%;" />
</div>
...
<img src="./assets/Snipaste_2023-04-24_10-56-45.png" style="zoom: 50%;" />

2. 环图 - Circle Graph: $C_n: V=\{v_1,v_2,\cdots,v_n\}; E=\{(v_1,v_2),\cdots.(v_n,v_1)\}$

<img src="./assets/Snipaste_2023-04-24_10-58-18.png" style="zoom:50%;" />

3. 轮图 - Wheel: $W_n: V=\{v_0,v_1,\cdots,v_n\}; E=\{(v_1,v_2),\cdots,(v_n,v_1)\}\cup\{(v_0,v_1),\cdots,(v_0,v_n)\}$

<img src="./assets/Snipaste_2023-04-24_11-06-04.png" style="zoom:50%;" />

4. 方体 n-Cubes: $Q_n: V\{0,1\}^n; E=\{(u,v):d_{(u,v)}=1\}, d_{(u,v)}=|\{i\in[n],u_i\ne v_i\}|$

<img src="./assets/Snipaste_2023-04-24_11-06-52.png" style="zoom:45%;" />
...
<img src="./assets/Snipaste_2023-04-24_11-18-37.png" style="zoom:38%;" />
...
<img src="./assets/Snipaste_2023-04-24_11-35-17.png" alt="./assets/Snipaste_2023-04-24_11-35-17" style="zoom:25%;" />
...
<img src="./assets/Snipaste_2023-04-28_08-40-25.png" style="zoom:38%;" />
...
<img src="./assets/Snipaste_2023-04-28_08-56-47.png" style="zoom:38%;" />
...
<img src="./assets/Snipaste_2023-04-28_09-22-25.png" style="zoom:38%;" />
...
<img src="./assets/Snipaste_2023-04-28_09-33-14.png" style="zoom:33%;" />
...
<img src="./assets/Snipaste_2023-05-08_10-43-44.png" style="zoom:25%;" />

- 有向图也是一样的定义, 但是注意, 有向图的边的顺序是固定的, 有前面的顶点指向后面的顶点.

<img src="./assets/Snipaste_2023-05-08_10-47-10.png" style="zoom:25%;" />
...
<img src="./assets/Snipaste_2023-05-08_11-15-21.png" style="zoom:38%;" />

- 切点 - cut vertex: 去掉这个点会有更多的连通分支产生
- 切边 - cut edge: 去掉这个边会有更多的连通分量产生

<img src="./assets/Snipaste_2023-05-08_11-18-27.png" style="zoom:33%;" />
...
<img src="./assets/Snipaste_2023-05-08_11-53-56.png" style="zoom:33%;" />
...
<img src="./assets/Snipaste_2023-05-12_08-37-26.png" style="zoom:33%;" />
...
<img src="./assets/Snipaste_2023-05-15_10-42-18.png" style="zoom:33%;" />
...
<img src="./assets/Snipaste_2023-05-15_11-15-55.png" style="zoom: 35%;" />
...
<img src="./assets/Snipaste_2023-05-15_11-26-04.png" style="zoom:33%;" />
...
- e.g. $K_{3,3}$不是平面图
  - <img src="./assets/Snipaste_2023-05-15_11-31-34.png" style="zoom:33%;" />

<img src="./assets/Snipaste_2023-05-15_11-32-16.png" alt="./assets/Snipaste_2023-05-15_11-32-16" style="zoom:33%;" />
...
<img src="./assets/Snipaste_2023-05-15_11-40-03.png" style="zoom:33%;" />
...
<img src="./assets/Snipaste_2023-05-15_11-51-39.png" style="zoom:25%;" />
...
<img src="./assets/Snipaste_2023-05-15_11-57-09.png" style="zoom:25%;" />
...
<img src="./assets/Snipaste_2023-05-22_10-52-01.png" style="zoom:33%;" />

1. 先序遍历 - Preorder

   <span><img src="./assets/Snipaste_2023-05-22_10-54-05.png" style="zoom:33%;" /><img src="./assets/Snipaste_2023-05-22_10-54-14.png" style="zoom:33%;" /><img src="./assets/Snipaste_2023-05-22_10-54-22.png" style="zoom:33%;" /></span>
...
<span><img src="./assets/Snipaste_2023-05-22_11-40-41.png" style="zoom: 15%;" />
<img src="./assets/Snipaste_2023-05-22_11-40-52.png" style="zoom:15%;" />
<img src="./assets/Snipaste_2023-05-22_11-41-08.png" style="zoom:15%;" />
<img src="./assets/Snipaste_2023-05-22_11-41-25.png" style="zoom:15%;" /></span>
