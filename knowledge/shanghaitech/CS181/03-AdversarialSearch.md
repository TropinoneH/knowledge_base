...
![image-](image-20241009102714101.png)

### Minmax Search

对抗: 红色状态是敌人的agent, 要让红色状态的state value越小越好, 蓝色状态的state value越大越好

![image-20241009103458020](image-20241009103458020.png)
...
![image-20241009112113288](image-20241009112113288.png)

第一步找到了3, 第二步中, 找到了一个2, 那么第二步的min的state value一定是一个小于2的值, 那么可以直接舍去这一个选择(要选择max的state value)

### Alpha-Beta Pruning

![image-20241009112505161](image-20241009112505161.png)
