...
> - 流程繁琐
> 
> 因此提出了一个端到端的训练策略. 但是由于在训练的时候, 会更新原始分布$x_0$, 导致得到的policy model不稳定, 于是提出了一个方法: [[2505.11123v1.pdf#page=5&selection=264,29,264,56|EMA]]
> 
> > [!tip]- Exponential Moving Average
