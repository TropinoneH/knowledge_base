...
> 
> 但是现在由于[[2010.11929|ViT]]模型架构的产生, 能够引入[[1706.03762|Transformer]]模型来支持在图像中嵌入Mask, 因此可以实现在视觉任务中的Masked Auto-Encoder
...
> > Masking
> 
> 使用类似[[2010.11929|ViT]]的方法, 对图片进行patch, 然后随机mask

> [!PDF|] [[2111.06377v3.pdf#page=3&selection=139,0,139,11|2111.06377v3, p.3]]
> > MAE encoder
> 
> 是一个[[2010.11929|ViT]], 但是仅针对没有被mask掉的部分.
...
> > MAE decoder
> 
> 将image embeddings和一个特殊的embedding vector(mask embedding)按照顺序进行拼接, 得到最终的`input_embeds`, 然后送给[[1706.03762|Transformer]]进行Self Attention, 最终得到一个完整的image的embeddings.
> 
