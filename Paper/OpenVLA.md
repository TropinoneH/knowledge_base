...
tags:
  ...
  - Robot
publish: CoRL 2024
pdf: "[[Paper/PDF/2406.09246v3.pdf]]"
rate: 🌟🌟🌟🌟
done: true
---
> [!note]- paper
...
按照[[RT-2]]的方法, 将每一个动作维度discrete成256个区间. 对于每一个动作维度, 将每一个区间quantize到$1\sim99$. 使用quantile是为了能够忽略training set中的异常动作. [[LLaMA2]]仅仅保留了100额外token可以添加, 因此选择覆盖最后256个token(是最不常用的token)
