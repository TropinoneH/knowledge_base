...
Motivation: 尝试解决[[2303.04137|Diffusion Policy]]等方法对机器人action的训练效果低下的问题(尝试解决loss collapse问题)
...
> 
> 数学推导: 根据[[2505.11123v1.pdf#page=4&selection=374,0,374,13|Loss Collapse]]部分的公式, 标准的[[2210.02747|Flow Matching]]的损失函数为:
...
> 注意, 该步骤不参与loss的计算
> 
> 然后, 设计一个[[Deep Learning#Autoencoder (AE)|AE]], 有编码器($F_\phi$)和解码器($G_\phi$). 参考[[2505.11123v1.pdf#page=6&selection=174,15,175,64|这一部分]], AutoEncoder的Encoder和Decoder都是由一个single-layer的[[1706.03762|Transformer]]组成.
> 
