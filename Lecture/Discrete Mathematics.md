...
![[Pasted image 20230424103607.png]]
...
![[Pasted image 20230424104624.png|300]]![[Pasted image 20230424104635.png|311]]![[Pasted image 20230424104655.png|328]]

![[Pasted image 20230424104852.png|308]]![[Pasted image 20230424104904.png|300]]![[Pasted image 20230424104912.png|300]]

### Special Simple Graph - 特殊的简单图

1. 完全图 - Complete Graph: $K_n: V=\{v_1, v_2,\cdots,v_n\};E=\{(v_i,v_j),1\leq i\ne j\leq n\}$

![[Pasted image 20230424105645.png]]

2. 环图 - Circle Graph: $C_n: V=\{v_1,v_2,\cdots,v_n\}; E=\{(v_1,v_2),\cdots.(v_n,v_1)\}$

![[Pasted image 20230424105818.png]]

3. 轮图 - Wheel: $W_n: V=\{v_0,v_1,\cdots,v_n\}; E=\{(v_1,v_2),\cdots,(v_n,v_1)\}\cup\{(v_0,v_1),\cdots,(v_0,v_n)\}$

![[Pasted image 20230424110604.png]]

4. 方体 n-Cubes: $Q_n: V\{0,1\}^n; E=\{(u,v):d_{(u,v)}=1\}, d_{(u,v)}=|\{i\in[n],u_i\ne v_i\}|$

![[Pasted image 20230424110652.png]]
...
![[Pasted image 20230424111837.png]]
...
![[Pasted image 20230424113517.png]]
...
![[Pasted image 20230428084025.png]]
...
![[Pasted image 20230428085647.png]]
...
![[Pasted image 20230428092225.png]]
...
![[Pasted image 20230428093314.png]]
...
![[Pasted image 20230508104344.png]]

- 有向图也是一样的定义, 但是注意, 有向图的边的顺序是固定的, 有前面的顶点指向后面的顶点.

![[Pasted image 20230508104710.png]]
...
![[Pasted image 20230508111521.png]]

- 切点 - cut vertex: 去掉这个点会有更多的连通分支产生
- 切边 - cut edge: 去掉这个边会有更多的连通分量产生

![[Pasted image 20230508111827.png]]
...
![[Pasted image 20230508112443.png]]
...
![[Pasted image 20230512083726.png]]
...
![[Pasted image 20230515104218.png]]
...
![[Pasted image 20230515111555.png]]
...
![[Pasted image 20230515112604.png]]
...
- e.g. $K_{3,3}$不是平面图
    - ![[Pasted image 20230515113134.png]]

![[Pasted image 20230515113216.png]]
...
![[Pasted image 20230515114003.png]]
...
![[Pasted image 20230515115139.png]]
...
![[Pasted image 20230515115709.png]]
...
![[Pasted image 20230522105201.png]]

1. 先序遍历 - Preorder

    ![[Pasted image 20230522105405.png|400]]![[Pasted image 20230522105414.png|473]]
    ![[Pasted image 20230522105422.png]]
...
![[Pasted image 20230522114041.png|400]]![[Pasted image 20230522114052.png|350]]

![[Pasted image 20230522114108.png|400]]![[Pasted image 20230522114125.png|390]]
